...
class GamePage00 extends StatelessWidget {
  const GamePage00({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      child: Column(
        ...
        children: [
          _buildButton1(),
          // สังเกตว่าเราแยกโค้ดตรงนี้ออกไปเป็นฟังก์ชัน (เมธอด) ชื่อ _buildButton1()
          _buildButton2(),
          // สังเกตว่าเราแยกโค้ดตรงนี้ออกไปเป็นฟังก์ชัน (เมธอด) ชื่อ _buildButton2()
          //_buildButton3(),
          // สังเกตว่าเราแยกโค้ดตรงนี้ออกไปเป็นฟังก์ชัน (เมธอด) ชื่อ _buildButton3()
          //_buildButton4(),
          // สังเกตว่าเราแยกโค้ดตรงนี้ออกไปเป็นฟังก์ชัน (เมธอด) ชื่อ _buildButton4()
        ],
      ),
    ));
  }
